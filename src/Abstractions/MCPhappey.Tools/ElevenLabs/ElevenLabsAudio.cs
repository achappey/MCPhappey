...
public static class ElevenLabsAudio
{
    ...
    public static async Task<CallToolResult?> ElevenLabsAudio_TextToSpeech(
        ...
        => await requestContext.WithExceptionCheck(async () =>
        {
            ...
            ArgumentNullException.ThrowIfNullOrWhiteSpace(voice_id);
    ...
    public static async Task<CallToolResult?> ElevenLabsAudio_TranscribeAudio(
        ...
        => await requestContext.WithExceptionCheck(async () =>
        {
            ...
            form.Add(new StreamContent(audio.Contents.ToStream()), "file", audio.Filename ?? "audio.mp3");
            form.Add("model_id".NamedField(typed.Model_Id));
