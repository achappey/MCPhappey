...
public static class OpenAIImages
{
    ...
    public static async Task<CallToolResult?> OpenAIImages_CreateImage(
     ...
     [Description("Image generation model to use. gpt-image-1 or gpt-image-1-mini.")] Model model = Model.gpt_image_1,
    ...
    public enum Model
    {
        ...
        gpt_image_1,   // default, model decides

        [EnumMember(Value = "gpt-image-1-mini")]
        gpt_image_1_mini,   // default, model decides
    }
