...
public static class StabilityAIImageEditService
{
    ...
    [McpServerTool(
        Title = "Erase objects from image (Stability AI)",
    ...
    [McpServerTool(
          Title = "Inpaint areas in image (Stability AI)",
          Name = "stabilityai_image_edit_inpaint",
          Destructive = true)]
    public static async Task<CallToolResult?> StabilityAI_ImageEdit_Inpaint(
          IServiceProvider serviceProvider,
          RequestContext<CallToolRequestParams> requestContext,
          ...
          [Description("Optional URL of mask image. White = replace/inpaint, black = keep.")] string? maskUrl = null,
          [Description("Output filename, without extension")] string? filename = null,
          CancellationToken cancellationToken = default) =>
          await requestContext.WithExceptionCheck(async () =>
          {
    ...
    [McpServerTool(
           Title = "Outpaint image (expand borders) with Stability AI",
    ...
    [McpServerTool(
           Title = "Search and replace objects in image (Stability AI)",
    ...
    [McpServerTool(
           Title = "Search and recolor objects in image (Stability AI)",
    ...
    [McpServerTool(
           Title = "Remove background from image (Stability AI)",
    ...
    public class StabilityInpaintImage
    {
        ...
        [Description("URL of the image to edit (SharePoint, OneDrive, or public).")]
        ...
        [JsonPropertyName("mask_url")]
        [Description("Optional mask image URL. White = replace/inpaint, black = keep. If omitted, alpha channel is used.")]
        public string? MaskUrl { get; set; }
