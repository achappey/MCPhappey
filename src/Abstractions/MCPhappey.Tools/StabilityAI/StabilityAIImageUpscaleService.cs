...
public static class StabilityAIImageUpscaleService
{
    ...
    [McpServerTool(
        Title = "Upscale image (Conservative 4K) with Stability AI",
    ...
    public static async Task<CallToolResult?> StabilityAI_ImageUpscale_Conservative(
        ...
        [Description("Describe what should stay or be lightly refined in the upscale result.")] string prompt,
    ...
    [Description("Enhance image resolution by 4× in ~1 second using Stability AI’s Fast Upscaler.")]
    [McpServerTool(
           Title = "Upscale image (Fast 4×) with Stability AI",
