...
{
    public static Server ToMcpServer(this Models.Database.Server server)
    {
        // ----------------------------
    ...
    public static ListResourcesResult ToListResourcesResult(this ICollection<Models.Database.Resource> resources)
        => new()
        {
    ...
    public static ListResourceTemplatesResult ToListResourceTemplatesResult(this ICollection<Models.Database.ResourceTemplate> resources)
    => new()
    {
    ...
    public static PromptTemplates ToPromptTemplates(this ICollection<Models.Database.Prompt> prompts)
   => new()
   {
